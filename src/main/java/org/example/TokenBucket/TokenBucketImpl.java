...
public class TokenBucketImpl {
    ...
    private static final double MAX_TOKENS =!testing ? 290000 : Double.MAX_VALUE;
    private static final double REFILL_RATE = !testing ? 290000 : Double.MAX_VALUE; // tokens per second
